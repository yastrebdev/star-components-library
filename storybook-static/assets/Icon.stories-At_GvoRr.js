import{j as r}from"./jsx-runtime-vNq4Oc-g.js";import{i as g,I as u}from"./Icon-EbFtFzyR.js";const p=[],h={icons:p},f=Object.keys(g);f.forEach(e=>{p.push(`${e}`)});const x={title:"Primitive/Icon",component:u,decorators:[e=>r.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"10px",padding:"0 24px"},children:r.jsx(e,{})})]},o={args:{name:"User",className:"",style:{},size:1/0},argTypes:{weight:{control:"select",options:["thin","light","regular","bold","fill","duotone"]}}},n=()=>h.icons.map(e=>{const d=()=>{navigator.clipboard.writeText(e).then(()=>{alert(`Copied: ${e}`)}).catch(m=>{console.error("Ошибка копирования в буфер обмена:",m),alert(`Not copied: ${e}`)})};return r.jsx(u,{name:e,onClick:d})});var t,s,a;o.parameters={...o.parameters,docs:{...(t=o.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    name: 'User',
    className: '',
    style: {},
