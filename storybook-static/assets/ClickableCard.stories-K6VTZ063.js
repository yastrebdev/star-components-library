import{j as a}from"./jsx-runtime-vNq4Oc-g.js";import{C as d}from"./Card-Njrw5mX8.js";const y={types:["primary","secondary"]},{ClickableCard:l}=d,u={title:"Simple/Card/ClickableCard",component:l,tags:["autodocs"],decorators:[t=>a.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"10px",padding:"0 24px"},children:a.jsx(t,{})})]},e={args:{type:"primary",iconName:"ChatCircle",title:"Text Writer",subtitle:"Youre scenario",className:"",style:{}}},r=()=>y.types.map((t,m)=>a.jsx(l,{type:t},m));var s,o,p;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    type: 'primary',
    iconName: 'ChatCircle',
    title: 'Text Writer',
